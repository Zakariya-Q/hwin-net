...
class TotalLoss(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.config = config
        from losses.prediction_loss import PredictionLoss, PredictionLossConfig
        from losses.recovery_loss import RecoveryLoss, RecoveryLossConfig
        from losses.noleak_loss import NoLeakageLoss, NoLeakageLossConfig
        from losses.equivariance_loss import EquivarianceLoss, EquivarianceLossConfig
        from losses.complexity_loss import ComplexityLoss, ComplexityLossConfig
