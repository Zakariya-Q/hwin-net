...
class HWINSchemaDataset(Dataset):
    def __init__(self, data_path, schema_path=None, platform_embeddings_path=None, target_column="y", num_variables=100, num_platforms=5, normalize_features=True, feature_mean_path=None, feature_std_path=None):
